...
<h5  style={{color: "#595353",font:" normal normal 800 44px/56px Montserrat"}}>{props.expo.name}</h5>

    <div className="row pl-5  mt-3">
<FaBuilding size="20" color="red"/><h3 style={{font: "normal normal 600 33px/40px Montserrat" , color:"#878282",marginLeft:"20px"}}>{props.expo.entreprise}</h3>
</div>
<div className="row pl-5  mt-3">
...
<div className="row pl-5  mt-3">
<MdLocalOffer size="20"color="red"/><h3 style={{font: "normal normal 600 33px/40px Montserrat" , color:"#878282",marginLeft:"20px"}}>{props.expo.hashtags}</h3>
</div>
